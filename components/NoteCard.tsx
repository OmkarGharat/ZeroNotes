...
const NoteCard: React.FC<NoteCardProps> = ({ note, onDelete }) => {
  ...
  return (
    <Link to={`/edit/${note.id}`} className="block group">
      <div className="bg-transparent rounded-lg border border-gray-200 dark:border-neutral-700 hover:border-gray-400 dark:hover:border-neutral-500 transition-colors duration-200 p-5 flex flex-col h-44 relative">
        ...
        <div className="flex justify-between items-start mb-2">
            ...
            <button
              ...
              className="text-gray-300 hover:text-red-500 transition-colors absolute right-4 top-5 opacity-0 group-hover:opacity-100"
        ...
        <div className="flex-grow">
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed line-clamp-3 font-normal">
